...
// @TODO Add zooming and navigation
...
let getRandomFillColor = () => {
  let earthFillColor = ["#FF3F7D", "#A98E00", "#B87ED1", "#008788", "#00C5C8", "#B00000", "#003173", "#E7AB49", "#FFF065", "#F99BA9", "#976b68"];

  return earthFillColor[getRandomInteger(10)];
};